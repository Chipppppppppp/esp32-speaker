...
//int ak4490 = 0x10; // device ak4490, 0010000 = 0x10 (if CAD1=CAD0=L, see datasheet p. 50)
//int ak4490 = 0x12; // device ak4490, 0010010 = 0x12 (if CAD1=H, CAD0=L, see datasheet p. 50)
//int ak4490 = 0x11; // device ak4490, 0010001 = 0x11 (if CAD1=L, CAD0=H, see datasheet p. 50)
...
#define PDN 25         // Set PDN pin to PB4 (for use with an STM32 uC) or any digital pin (for an Arduino). You should connect this pin to your 4490's PDN pin.
#define DSDPIN 26      // Set DSD pin to PB3 (for use with an STM32 uC) or any digital pin (for an Arduino). You should connect this pin to your USB-to-I2S module's "DSD indicator" pin.
...
void setup()
{
  ...
  // A2DP接続を初期化
  a2dp_sink.start("ESP32_AK4490");  // Bluetoothデバイス名を設定
